...
private:
    ...
    // ============ [FIX-V1 START] Helpers de nivel para logging estandarizado ============
    ...
    void debugInfo(const char* msg);
    void debugInfo(const String& msg);
    void debugVerbose(const char* msg);
    void debugVerbose(const String& msg);
    // ============ [FIX-V1 END] ============
     ...
     *          Restaura GPIO13 a INPUT al finalizar (compatible con ADC).
