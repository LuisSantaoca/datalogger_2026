...
bool FileManager::appendLine(const String& line) {
    if (!isInitialized) {
        return false;
    }
...
bool FileManager::readLines(String* lines, int maxLines, int& count) {
    if (!isInitialized) {
        return false;
    }
...
bool FileManager::readUnprocessedLines(String* lines, int maxLines, int& count) {
    if (!isInitialized) {
        return false;
    }
...
bool FileManager::markLineAsProcessed(int lineNumber) {
...
bool FileManager::markLinesAsProcessed(int* lineNumbers, int count) {
...
bool FileManager::removeProcessedLines() {
    if (!isInitialized) {
        return false;
    }
